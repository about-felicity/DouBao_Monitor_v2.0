...
SAVE_SCRIPT = os.path.join(BASE_DIR, "legacy", "doubao", "core", "save_doubao_refs.py")
PAGE_GRABBER_SCRIPT = os.path.join(BASE_DIR, "legacy", "doubao", "ref_extension", "content.js")
SOURCE_AI_WORKER_SCRIPT = os.path.join(BASE_DIR, "services", "analysis", "doubao_source_worker.py")
PRODUCT_AI_WORKER_SCRIPT = os.path.join(BASE_DIR, "services", "analysis", "doubao_product_worker.py")
