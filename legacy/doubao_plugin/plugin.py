...
RECEIVER_QUEUE = ROOT / "collectors" / "doubao" / "mumu" / "lan_receiver_queue"
...
class Plugin(ModelPlugin):
    ...
    execution = "remote"
    config = ROOT / "collectors" / "doubao" / "mumu" / "doubao_mumu_panel_config.json"
    runner = ROOT / "collectors" / "doubao" / "mumu" / "doubao_mumu_scheduled_job.py"
    readiness_path = ROOT / "collectors" / "doubao" / "mumu" / "doubao_panel_readiness.json"
