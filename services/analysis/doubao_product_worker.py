...
REBUILD_SCRIPT = BASE_DIR / "tools" / "maintenance" / "rebuild_doubao_products_from_answers.py"
SAVE_SCRIPT = BASE_DIR / "collectors" / "doubao" / "core" / "save_doubao_refs.py"
...
def finish_pending_save(pending_path, payload, message):
    try:
        ...
        pass
    try:
        from legacy.doubao.core import run_doubao_latest_grab as grabber
