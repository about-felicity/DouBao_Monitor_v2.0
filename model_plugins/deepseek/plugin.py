...
class Plugin(ModelPlugin):
    ...
    results = ROOT / "deepseek_chrome" / "data" / "deepseek_results.jsonl"
    dashboard = ROOT / "deepseek_chrome" / "data" / "dashboard.json"
    execution = "remote"
    ...
    def load_questions(self) -> list[str]:
        questions = ROOT / "deepseek_chrome" / "questions.txt"
