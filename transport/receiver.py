...
MODELS = {"deepseek", "yuanbao", "wenxin"}
TARGETS = {
    "deepseek": ROOT / "collectors" / "deepseek" / "chrome" / "data" / "deepseek_results.jsonl",
    "yuanbao": ROOT / "collectors" / "yuanbao" / "yuanbao_results.jsonl",
    "wenxin": ROOT / "collectors" / "wenxin" / "wenxin_results.jsonl",
}
