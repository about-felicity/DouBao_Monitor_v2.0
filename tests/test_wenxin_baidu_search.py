...
from collectors.wenxin.controller import (
...
from collectors.wenxin.wenxin_loop import (
...
class WenxinBaiduSearchTests(unittest.TestCase):
    ...
    def test_search_collector_extracts_answer_sources_and_resolves_redirect(self):
        ...
        with mock.patch("collectors.wenxin.controller.time.sleep", return_value=None):
